...
output_path = "your_path/grad_cam"
...
model_efficient = tf.keras.models.load_model("your_path/Efficient/Efficient_Falseunfree.h5")
model_inception = tf.keras.models.load_model("your_paths/Inception/Inception_Falseunfree.h5")
model_mobilenet = tf.keras.models.load_model("your_path/Mobilenet/Mobilenet_Falseunfree.h5")
model_xception = tf.keras.models.load_model("your_path/Xception/Xception_Falseunfree.h5")
model_vgg16 = tf.keras.models.load_model("your_path/VGG16/vgg16_Falseunfree.h5")
...
############ Efficient  ################################
model_efficient_1 = tf.keras.models.load_model("your_path/Efficient/Efficient_False.h5")
model_efficient_2 = tf.keras.models.load_model("your_path/Efficient/Efficient_True.h5")
model_efficient_3 = tf.keras.models.load_model("your_path/Efficient/Efficient_Falseunfree.h5")
model_efficient_4 = tf.keras.models.load_model("your_path/Efficient/Efficient_Trueunfree.h5")
...
output_path_effi = "your_pathgrad_cam" + "/Efficient/"
...
############ Mobilenet  ################################
model_mobilenet_1 = tf.keras.models.load_model("your_path/Mobilenet/Mobilenet_False.h5")
model_mobilenet_2 = tf.keras.models.load_model("your_path/Mobilenet/Mobilenet_True.h5")
model_mobilenet_3 = tf.keras.models.load_model("your_path/Mobilenet/Mobilenet_Falseunfree.h5")
model_mobilenet_4 = tf.keras.models.load_model("your_path/Mobilenet/Mobilenet_Trueunfree.h5")

mobilenet_models = [model_mobilenet_1,model_mobilenet_2,model_mobilenet_3,model_mobilenet_4]
output_path_mobi = "your_path/grad_cam" + "/Mobilenet/"
